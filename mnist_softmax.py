...
exp.in_out_distribution_distinction(model, mnist_test_x, fmnist_test_x, "FashionMNIST")
exp.in_out_distribution_distinction(model, mnist_test_x, np.random.normal(size=(10000, 28, 28)), "WhiteNoise")
exp.in_out_distribution_distinction(model, mnist_test_x, np.random.uniform(size=(10000, 28, 28)), "UniformNoise")
